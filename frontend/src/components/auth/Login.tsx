...
import { HOME_PAGE, SIGNUP_PAGE, VOLUNTEER_DASHBOARD_PAGE } from "../../constants/Routes";
      ...
      <Box width="md" pt={16} pr={16} pl={16} pb={10} m={5} background="white" rounded={20}>
        ...
        <Box my={4} textAlign="left">
          <form onSubmit={onLogInClick}>
            ...
            <Center mt={4} mb={4}>
              <Button type="submit" isDisabled={email === "" || password === ""} width="full" mt={4} color="white" background="#28214C" _hover={{opacity: "0.8"}}>
                Log In
              </Button>
            </Center>
            <Center>
              <Text fontSize="sm">Don&apos;t have an account? <Link as={ReactRouterLink} to={SIGNUP_PAGE} textDecoration="underline" fontWeight="semibold">Register</Link></Text>
            </Center>
          </form>
        </Box>
      </Box>
